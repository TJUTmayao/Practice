...
public class CheckServiceImpl implements CheckService {
    ...
    public Result getCheckResult(String key) {
        /**
         *
         * 功能描述: 检查用户是否已登录，100-成功，500-用户状态不正确，404-未登录
         *
         * @param: [token]
         * @return: pojo.Result
         * @auther: 11432_000
        ...
        //将缓存信息转换为pojo对象
        XslManager xslManager =(XslManager) JsonUtils.jsonToPojo(json, XslManager.class);
        int status = checkManagerStatus(xslManager.getManagerName());
        if (status != 0){
